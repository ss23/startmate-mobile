                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          child: Text((set.slots![0].entrant != null) ? set.slots![0].entrant!.name! : '', overflow: TextOverflow.ellipsis),
                        ),
                        Container(
                          width: 200,
                          ...
                          padding: const EdgeInsets.only(left: 14, right: 8, top: 1, bottom: 1),
                          child: Text((set.slots![1].entrant != null) ? set.slots![1].entrant!.name! : '', overflow: TextOverflow.ellipsis),
                        ),
                        const SizedBox(
                          height: 10,
                        ),
